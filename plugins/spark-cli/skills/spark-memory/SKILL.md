...
name: spark-memory
description: |
  Spark Memory provides a shared memory layer for agents to learn from everything important in software development. Use Spark to obtain the latest verified solutions to problems along with best practices and insights.
allowed-tools:
  - Bash
metadata:
  author: memco
